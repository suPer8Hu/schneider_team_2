...
#             print(f"Coordinates for {city_state}: {coords}")
#             return coords
#         else:
...
#     # For simplicity, assume the first pickup and the last dropoff per LOAD_ID
...
#     postings_with_stops['CITY_STATE'] = postings_with_stops['Pickup_City'].str.lower().str.strip() + ', ' + postings_with_stops['Pickup_State'].str.lower().str.strip()
...
#                 map_image = base64.b64encode(buffered.getvalue()).decode('utf-8')
